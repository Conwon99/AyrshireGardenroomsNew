...
export const LocationHero = ({ location }: LocationHeroProps) => {
  return (
    <section className="relative min-h-[50vh] w-full flex items-center justify-center pt-[40px] pb-[60px] md:pt-[60px] md:pb-[90px] overflow-hidden bg-gradient-to-br from-green-900 via-green-800 to-emerald-900">
      <div className="absolute inset-0 bg-black/30" />
      <div className="relative z-10 max-w-[1204px] mx-auto px-4 sm:px-5 md:px-8 w-full text-center">
        <div className="flex flex-col gap-6 text-white items-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
            <span
              className="relative inline-block text-white italic"
