...
export const centralBeltLocations: Location[] = [
  loc(
    ...
    "From the West End to the Southside, Glasgow homeowners know Scottish weather can be tough on outdoor spaces. We help you get a garden room that stands up to the rain and looks great year-round.",
    "Across Glasgow we install garden rooms that suit local properties and the climate. Whether you're after a home office in the West End or a garden studio in the Southside, we deliver quality you can rely on.",
    ...
    "Good transport links and a range of property types make Glasgow a great place for garden rooms. We factor in access, drainage, and Scottish weather so your project lasts.",
  ...
  loc(
    ...
    "Edinburgh's weather and varied property types mean outdoor spaces need to be built right. We bring garden room solutions that fit your area and the local climate.",
    "From Newington to Leith, we provide garden rooms designed for Edinburgh's conditions. Our installations are built to last and to suit your property.",
  ...
  loc(
    ...
    "Stirling and the surrounding areas deserve outdoor spaces that handle wind and rain. We install garden rooms built for Central Scotland's climate.",
    "Across Stirling we offer garden rooms that suit local homes and gardens. Quality materials and careful installation mean your investment lasts.",
  ...
  loc(
    ...
    "Falkirk and the surrounding towns need outdoor structures that cope with Central Belt weather. We deliver garden rooms that are built to last.",
    "We serve Falkirk, Grangemouth, Larbert and nearby areas with garden room installations. Local knowledge and quality materials are at the heart of what we do.",
  ...
  loc(
    ...
    "Paisley and the wider Renfrewshire area get their share of rain and wind. We build garden rooms that stand up to the weather and look great.",
    "Across Paisley and nearby towns we install garden rooms tailored to local properties. You get a professional finish and advice that fits your area.",
  ...
  loc(
    ...
    "East Kilbride's mix of green spaces and housing makes it ideal for garden rooms. We help you make the most of your outdoor space in all weathers.",
    "We provide garden room services across East Kilbride. Our installations are designed for Scottish conditions and local property types.",
    ...
    "The town's layout and transport links make scheduling straightforward. We focus on quality and durability so your garden room performs for years.",
  ...
  loc(
    ...
    "Hamilton and South Lanarkshire homeowners need outdoor solutions that cope with the climate. We install garden rooms built for the long term.",
    "Across Hamilton and nearby areas we deliver garden rooms that suit local homes. Quality materials and careful installation are standard.",
  ...
  loc(
    ...
    "Motherwell and North Lanarkshire deserve outdoor spaces that last. We bring garden room installations that handle the weather and add real value.",
    "We serve Motherwell and the surrounding area with garden rooms. Each project is tailored to your property and how you want to use the space.",
  ...
  loc(
    ...
    "Coatbridge and the Monklands area need outdoor structures that stand up to Central Scotland's weather. We deliver garden rooms built to last.",
    "Across Coatbridge we install garden rooms for local homeowners. You get a professional finish and materials chosen for durability.",
  ...
  loc(
    ...
    "Airdrie homeowners know that outdoor spaces need to handle the elements. We install garden rooms that look good and perform in the Scottish climate.",
    "We provide garden room services across Airdrie and the surrounding area. Quality and local knowledge are at the heart of every project.",
  ...
  loc(
    ...
    "Cumbernauld's mix of green space and housing is ideal for garden rooms. We help you create outdoor spaces that work in all weathers.",
    "Across Cumbernauld we deliver garden rooms tailored to local properties. Our installations are built for Scottish conditions.",
  ...
  loc(
    ...
    "Livingston and West Lothian homeowners need outdoor solutions that cope with the climate. We install garden rooms built for the long term.",
    "We serve Livingston and the surrounding area with garden rooms. Each project is tailored to your property and local conditions.",
  ...
  loc(
    ...
    "Bathgate and West Lothian deserve outdoor spaces that last. We bring garden room installations that handle the weather and add value.",
    "Across Bathgate and nearby towns we install garden rooms. Quality materials and careful installation are standard for every job.",
  ...
  loc(
    ...
    "Linlithgow's historic character and green spaces suit garden rooms. We help you create outdoor spaces that complement your property.",
    "We provide garden room services across Linlithgow and the surrounding area. Our installations are designed for local conditions and property types.",
  ...
  loc(
    ...
    "Kirkintilloch and East Dunbartonshire need outdoor structures that stand up to the weather. We deliver garden rooms built to last.",
    "Across Kirkintilloch we install garden rooms for local homeowners. You get a professional finish and materials chosen for Scottish conditions.",
  ...
  loc(
    ...
    "Bishopbriggs homeowners know that outdoor spaces need to handle rain and wind. We install garden rooms that look good and perform year-round.",
    "We serve Bishopbriggs and East Dunbartonshire with garden rooms. Each project is tailored to your property and how you want to use the space.",
  ...
  loc(
    ...
    "Bearsden's gardens and property types suit garden rooms. We help you create outdoor spaces that stand up to Scottish weather.",
    "Across Bearsden we deliver garden rooms tailored to local properties. Our installations are built for durability and style.",
  ...
  loc(
    ...
    "Newton Mearns and East Renfrewshire deserve outdoor spaces that last. We bring garden room installations that add value and handle the climate.",
    "We serve Newton Mearns and the surrounding area with garden rooms. Quality materials and careful installation are standard.",
  ...
  loc(
    ...
    "Dunfermline and West Fife need outdoor solutions that cope with the weather. We install garden rooms built for the long term.",
    "Across Dunfermline we install garden rooms for local homeowners. You get a professional finish and advice that fits your area.",
  ...
  loc(
    ...
    "Kirkcaldy and the Fife coast get their share of wind and rain. We build garden rooms that stand up to the elements and look great.",
    "We provide garden room services across Kirkcaldy and the surrounding area. Our installations are designed for local conditions.",
...
export const ayrshireLocations: Location[] = [
  loc(
    ...
    "Kilmarnock and East Ayrshire homeowners need outdoor spaces that handle the weather. We install garden rooms built for Ayrshire's climate.",
    "Across Kilmarnock we deliver garden rooms tailored to local properties. Quality and local knowledge are at the heart of every project.",
  ...
  loc(
    ...
    "Kilwinning and North Ayrshire deserve outdoor spaces that last. We bring garden room installations that add value and stand up to the climate.",
    "We serve Kilwinning and the surrounding area with garden rooms. Each project is tailored to your property and local conditions.",
  ...
  loc(
    ...
    "Irvine and North Ayrshire need outdoor structures that cope with coastal weather. We deliver garden rooms built to last.",
    "Across Irvine we install garden rooms for local homeowners. You get a professional finish and materials chosen for Ayrshire conditions.",
  ...
  loc(
    ...
    "Prestwick's coastal location means outdoor spaces need to be built right. We install garden rooms that stand up to the wind and rain.",
    "We provide garden room services across Prestwick and the surrounding area. Our installations are designed for Ayrshire's coastal climate.",
  ...
  loc(
    ...
    "Ayr and South Ayrshire homeowners know that coastal weather can be tough. We build garden rooms that look good and perform year-round.",
    "Across Ayr we deliver garden rooms tailored to local properties. Quality materials and careful installation are standard.",
  ...
  loc(
    ...
    "Troon's seafront gardens face some of the toughest weather on the Ayrshire coast. We design garden rooms that shrug off salt air and westerly gales without losing their good looks.",
    "From the marina to Barassie, we install garden rooms built for Troon's exposed coastal setting. Every project uses materials chosen to cope with sea spray and shifting sand.",
    "Troon's mix of Victorian villas and modern coastal homes each bring their own challenges. We've fitted garden rooms behind sea walls and on sandy, well-drained plots alike.",
  ...
  loc(
    ...
    "Saltcoats and the Three Towns know the North Ayrshire coast doesn't do things by halves when the weather turns. Our garden rooms are built to take it.",
    "We serve Saltcoats and neighbouring Ardrossan and Stevenston with garden room installations designed for this stretch of coastline.",
  ...
  loc(
    ...
    "Ardrossan's harbour and ferry town setting means exposed, windy gardens are the norm. We build garden rooms rated for genuinely coastal conditions.",
    "Across Ardrossan we deliver garden rooms for homes near the harbour and further inland, all built to the same high standard.",
  ...
  loc(
    ...
    "Largs' seafront and marina setting is stunning, but it puts real demands on outdoor structures. We build garden rooms designed for the Firth of Clyde's weather.",
    "We install garden rooms across Largs, from the seafront to the hillside streets above the town, all tailored to local conditions.",
  ...
  loc(
    ...
    "Dalry's inland North Ayrshire setting means gardens deal with plenty of rain but less wind exposure than the coast. We build garden rooms to suit.",
    "Across Dalry we provide garden room installations designed for local properties, from the town centre out to the surrounding countryside.",
  ...
  loc(
    ...
    "We serve Beith and the surrounding villages with garden room installations designed for the local climate and terrain.",
  ...
  loc(
    ...
    "Stewarton, East Ayrshire's historic bonnet-making town, has plenty of gardens that deserve a proper garden room. We build for the local climate.",
    "Across Stewarton we install garden rooms suited to the town's mix of period and modern homes, with a focus on quality and longevity.",
  ...
  loc(
    ...
    "We provide garden room installations across Dreghorn, tailored to the town's mostly residential streets and modern housing.",
  ...
  loc(
    ...
    "Springside is a small North Ayrshire village where gardens are often larger than in the surrounding towns, giving real scope for a garden room.",
    "We serve Springside and the neighbouring villages with garden room installations built for local conditions.",
  ...
  loc(
    ...
    "Across Dundonald we install garden rooms designed for the village's mostly larger, established gardens.",
  ...
  loc(
    ...
    "Symington is a quiet South Ayrshire village with generous gardens, ideal for a custom garden room.",
    "We provide garden room services across Symington, tailored to the village's larger plots and rural setting.",
  ...
  loc(
    ...
    "Tarbolton, with its strong Robert Burns connections, has plenty of traditional gardens that suit a well-built garden room.",
    "Across Tarbolton we install garden rooms designed to complement the village's mix of older and newer homes.",
  ...
  loc(
    ...
    "We serve Mauchline and the surrounding countryside with garden room installations suited to local homes.",
  ...
  loc(
    ...
    "Cumnock, at the heart of East Ayrshire's former coalfield area, has seen real regeneration, and many homeowners here are investing in garden rooms.",
    "Across Cumnock we install garden rooms tailored to the town's mix of traditional streets and newer housing.",
  ...
  loc(
    ...
    "Newmilns, one of the Irvine Valley's historic weaving towns, has plenty of traditional gardens well suited to a garden room.",
    "We provide garden room installations across Newmilns, built to suit the town's older housing stock and river valley setting.",
  ...
  loc(
    ...
    "Across Darvel we install garden rooms designed for the town's traditional gardens and its slightly higher, more exposed setting.",
  ...
  loc(
    ...
    "Galston sits along the River Irvine in East Ayrshire, with gardens that benefit from a well-designed garden room.",
    "We serve Galston with garden room installations suited to the town's riverside setting and mix of housing types.",
  ...
  loc(
    ...
    "Hurlford, just east of Kilmarnock, has a good mix of traditional and modern homes suited to garden rooms.",
    "Across Hurlford we install garden rooms designed for local properties, from riverside streets to newer estates.",
  ...
  loc(
    ...
    "We provide garden room installations across Fenwick, designed for the village's exposed, elevated setting.",
  ...
  loc(
    ...
    "Crosshouse, just outside Kilmarnock, has a good number of family homes with gardens well suited to a garden room.",
    "Across Crosshouse we install garden rooms tailored to the village's mostly residential streets.",
  ...
  loc(
    ...
    "We serve Kilmaurs with garden room installations designed to complement the village's historic character.",
  ...
  loc(
    ...
    "Dalrymple, a quiet village on the River Doon in South Ayrshire, has gardens well suited to a custom garden room.",
    "Across Dalrymple we install garden rooms designed for the village's rural, riverside setting.",
  ...
  loc(
    ...
    "Maybole, historic capital of Carrick in South Ayrshire, has traditional gardens that deserve a well-crafted garden room.",
    "We provide garden room installations across Maybole, suited to the town's older housing stock and surrounding countryside.",
  ...
  loc(
    ...
    "Across Girvan we install garden rooms designed for genuinely coastal conditions, from the harbourfront to the streets above the town.",
  ...
  loc(
    ...
    "We serve West Kilbride and neighbouring Seamill with garden room installations designed for this exposed stretch of coast.",
  ...
  loc(
    ...
    "Across Fairlie we install garden rooms built for the village's exposed coastal setting, close to Kelburn Estate.",
    "Fairlie's narrow coastal strip means gardens here are often compact, so we design garden rooms that make the most of the space.",
  ...
  loc(
    ...
    "We provide garden room installations across Dalmellington, designed for its upland, former mining-town setting.",
  ...
  loc(
    ...
    "Across New Cumnock we install garden rooms designed for the town's former mining-community housing and rural surroundings.",
  ...
  loc(
    ...
    "Catrine, a historic mill village on the River Ayr, has traditional gardens well suited to a carefully built garden room.",
    "We serve Catrine with garden room installations designed to suit the village's riverside setting and older housing.",
  ...
  loc(
    ...
    "Ochiltree, a rural East Ayrshire village with strong literary connections, has gardens that suit a well-designed garden room.",
    "Across Ochiltree we install garden rooms tailored to the village's rural setting and traditional housing.",
  ...
  loc(
    ...
    "Coylton, a South Ayrshire village between Ayr and Cumnock, has plenty of family gardens suited to garden rooms.",
    "We provide garden room installations across Coylton, designed for the village's mostly residential, semi-rural streets.",
  ...
  loc(
    ...
    "Drongan, a former mining village in South Ayrshire, has seen real change over the years, and many homeowners here are now investing in garden rooms.",
    "Across Drongan we install garden rooms suited to the village's post-mining housing stock and surrounding farmland.",
  ...
  loc(
    ...
    "Annbank, a small South Ayrshire village near the River Ayr, has gardens well suited to a custom garden room.",
    "We serve Annbank and neighbouring Mossblown with garden room installations built for the local area.",
  ...
  loc(
    ...
    "Across Monkton we install garden rooms designed for the village's mostly residential streets and coastal-adjacent setting.",
  ...
  loc(
    ...
    "Ballantrae, on South Ayrshire's remote southern coast, faces some of the harshest weather in the region. We build garden rooms to match.",
    "We provide garden room installations across Ballantrae, designed for its exposed, Atlantic-facing coastal setting.",
...
export const LOCATION_SERVICES = ["garden-rooms"] as const;
