export const AboutHero = () => {
  return (
    <section className="relative min-h-[60vh] w-full flex items-center justify-center pt-[40px] pb-[60px] md:pt-[60px] md:pb-[90px] overflow-hidden bg-gradient-to-br from-green-900 via-green-800 to-emerald-900">
