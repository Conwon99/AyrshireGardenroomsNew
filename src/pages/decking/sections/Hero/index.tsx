...
interface DeckingHeroProps {
  location?: { name: string; regionLabel?: string };
}

export const DeckingHero = ({ location }: DeckingHeroProps) => {
  const headingText = location
    ? `Deck Installation in ${location.name}`
    : "Deck Installation Across Scotland";
  const subText = location
    ? `Transform your outdoor space with beautiful, professional decking in ${location.name} and across ${location.regionLabel || "Scotland"}. Free quotes, fully insured, years of experience.`
    : "Transform your outdoor space with beautiful, professional decking. Expert deck installation across Scotland. Free quotes, fully insured, years of experience.";
  const altSuffix = location ? ` in ${location.name}` : " in Scotland";
  const images = [
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.45 PM (1).jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.45 PM (2).jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.45 PM (3).jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.45 PM.jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.46 PM (1).jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.46 PM (2).jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.46 PM (3).jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.46 PM.jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.47 PM (1).jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.47 PM (2).jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.47 PM (3).jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.47 PM (4).jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.47 PM (5).jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.47 PM.jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.48 PM (1).jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.48 PM (2).jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.48 PM (3).jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.48 PM.jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.49 PM (1).jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.49 PM (2).jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.49 PM (3).jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.49 PM (4).jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.49 PM.jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.50 PM (1).jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.50 PM (2).jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.50 PM (3).jpeg",
    "/imgs/decking/WhatsApp Image 2026-01-27 at 6.23.50 PM.jpeg"
  ];
  ...
  return (
    <section id="hero" className="relative min-h-[90vh] w-full flex items-center justify-center pt-[40px] pb-[60px] md:pt-[60px] md:pb-[90px] overflow-hidden">
